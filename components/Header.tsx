...
export default function Header() {
  ...
  const darkHandler = (darkSwitch: boolean) => {
    setDark(darkSwitch);
    localStorage.setItem('dark-mode', JSON.stringify(darkSwitch));
  };

  useEffect(() => {
    const localDark: boolean | null = JSON.parse(
      localStorage.getItem('dark-mode') as string
    );
    setDark(localDark as boolean);
    if (localDark) {
  ...
  const navHandler = () => {
    const toggleNav = document.getElementById('toggle_nav') as HTMLInputElement;
    if (toggleNav) {
  ...
  return (
    <header className="container w-100% h-auto px-4 py-6 flex items-center justify-between text-slate-500 bg-slate-200 dark:bg-slate-800">
      <Link
        href="/"
      ...
      <nav className="">
        <ul className="flex items-center justify-center">
          ...
          <li className="relative group px-3 py-2">
            ...
            <div className="absolute lg:-left-48 top-3 transition group-hover:translate-y-5 translate-y-0 opacity-0 invisible group-hover:opacity-100 group-hover:visible duration-500 ease-in-out group-hover:transform z-50 min-w-[800px] transform">
                        ...
                        >
                          ...
                          <div>
                            ...
                            <p className="text-gray-500 mt-2 font-normal text-sm">
                              Discover how we empower <br /> businesses to leap
                              ahead with <br /> custom self-service portals.
                            </p>
                          </div>
                        </Link>
                      </li>
                    ...
                    <ul className="text-[15px]">
                      <li>
                        ...
                        >
                          ...
                          />
                          <div>
                            <h6 className="text-md text-blue-600">Shmooz AI</h6>
                            <p className="text-gray-500 font-normal text-sm">
